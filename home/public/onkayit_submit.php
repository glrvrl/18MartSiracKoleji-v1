...
if (isset($_SESSION[$rateLimitKey])) {
    ...
    if (time() - $lastSubmission < $rateLimitTime) {
        header('Location: onkayit.html?status=error&msg=rate_limit');
        exit;
    }
}
...
try {
    ...
    $emailKonu = 'Sirac Koleji - Yeni On Kayit Basvurusu - ' . $studentName;
